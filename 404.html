...
<body>
	...
	<div id="canvas">
		<div id="box_wrapper">
			...
			<section class="page_toplogo ds s-overlay s-py-30">
				<div class="container">
			...
			<header class="page_header ds ms s-overlay nav-bordered justify-nav-center">
			...
			<section class="ls s-py-60 s-py-lg-120 s-parallax s-overlay error-404 not-found page_404">
				<div class="container">
					...
					<div class="row">
						<div class="col-sm-12 text-center">
							...
							<header class="page-header">
								...
								<p class="fw-900">
									<span class="color-main">Oh, no!</span> <span class="color-dark">Really?</span>
								</p>
							</header>
							<!-- .page-header -->
							...
							<div class="page-content">
								<div class="mt-40">
									<a href="index.html" class="btn btn-small btn-maincolor">Go home page</a> <span class="color-dark m-25">or</span> <a href="#" class="btn btn-small btn-outline-maincolor">Return previous page</a>
								</div>
							</div>
							<!-- .page-content -->
						</div>
			...
			<section class="page_copyright ds s-py-60">
				<div class="container">
